# Generated by Django 5.1.3 on 2024-11-26 16:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_day', models.CharField(help_text='월~일 (7자리 이진수)', max_length=7, verbose_name='강의 요일')),
                ('lecture_time', models.CharField(max_length=50)),
                ('semester', models.CharField(default='1', max_length=1, verbose_name='학기')),
                ('year', models.CharField(default='2024', max_length=4, verbose_name='년도')),
            ],
            options={
                'verbose_name': '강의',
                'db_table': 'lecture',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.AutoField(primary_key=True, serialize=False, verbose_name='고유 아이디')),
                ...
                ('total_point', models.PositiveIntegerField(default=0, verbose_name='점수 총점')),
                ('interests', models.TextField(blank=True, verbose_name='관심 있는 과목')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curious_count', models.PositiveIntegerField(default=0)),
                ('nickname', models.CharField(blank=True, max_length=50, null=True)),
                ('anonymous', models.BooleanField(default=False)),
                ('lecture_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='hurdlethon.lecture', verbose_name='강의')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='hurdlethon.question')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
